...
**Live:** [https://relaxed-weasel-dolibarr.cloud.nexlayer.ai](https://relaxed-weasel-dolibarr.cloud.nexlayer.ai)  
...
**dolibarr** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/dolibarr/dolibarr:latest
    path: /
    servicePorts:
    - 80
    vars:
      DOLI_ADMIN_LOGIN: admin
      DOLI_ADMIN_PASSWORD: nexlayer2024
      DOLI_DB_HOST: mysql.pod
      DOLI_DB_USER: dolibarr
      DOLI_DB_PASSWORD: dolibarr
      DOLI_DB_NAME: dolibarr
      DOLI_URL_ROOT: "https://relaxed-weasel-dolibarr.cloud.nexlayer.ai"
    volumes:
    - name: dolibarr-html
